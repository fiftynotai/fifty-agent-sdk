...
durable record of every agent action. :class:`fifty_agent_sdk.runner.AgentRunner`
...
:class:`fifty_agent_sdk.audit.console.ConsoleAuditSink` — the dev default), a SQL
table (:class:`fifty_agent_sdk.audit.sql.SqlAuditSink`), or any other backend.
    ...
    async def record(self, event: AuditEvent) -> None:
        ...
        Raises:
            Exception: Implementations MAY raise on backend failure. The
                :class:`fifty_agent_sdk.runner.AgentRunner` catches the exception,
