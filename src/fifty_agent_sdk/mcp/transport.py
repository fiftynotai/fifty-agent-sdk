...
:class:`fifty_agent_sdk.mcp.client.MCPClient` is transport-agnostic.
...
Streamable HTTP today, stdio later
    ...
    (notably :class:`fifty_agent_sdk.tools.mcp_provider.MCPProvider`) changes,
    because it only ever sees an :class:`fifty_agent_sdk.mcp.client.MCPClient`.
...
Lifecycle
    ...
    streams. Per the :class:`fifty_agent_sdk.mcp.client.MCPClient` ``client=``
...
class Transport(Protocol):
    ...
    and the ``initialize`` handshake. :class:`fifty_agent_sdk.mcp.client.MCPClient`
...
class StreamableHttpTransport:
    ...
    Args:
        ...
        user_agent: ``User-Agent`` header set on the owned httpx client. When
            ...
            :class:`fifty_agent_sdk.mcp.client.MCPClientConfig`).
