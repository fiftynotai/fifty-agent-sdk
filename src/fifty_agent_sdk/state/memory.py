"""In-memory dict implementation of :class:`fifty_agent_sdk.state.protocol.StateStore`.
...
class MemoryStateStore:
    """Pure in-memory implementation of :class:`fifty_agent_sdk.state.protocol.StateStore`.
    ...
    Failure model:
        ...
        :class:`fifty_agent_sdk.errors.StateStoreError`.
    """
