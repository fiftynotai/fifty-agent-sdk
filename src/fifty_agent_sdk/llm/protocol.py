...
Implementations MUST raise :class:`fifty_agent_sdk.errors.LLMError` (with
...
class LLMClient(Protocol):
    ...
    Error contract:
        Implementations MUST raise :class:`fifty_agent_sdk.errors.LLMError` (or a
    ...
    async def complete(self, request: ChatRequest) -> ChatResponse:
        ...
        Raises:
            fifty_agent_sdk.errors.LLMError: If the provider call fails for any
    ...
    def stream(self, request: ChatRequest) -> AsyncIterator[ChatResponse]:
        ...
        :data:`fifty_agent_sdk.llm.types.FinishReason` literals. ``usage`` may be
        ...
        Raises:
            fifty_agent_sdk.errors.LLMError: If the stream fails to open or fails
